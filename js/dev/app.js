...
function initSliders() {
  ...
  if (document.querySelector(".product-block__slider")) {
    const parentSliders = document.querySelector(".product-block__slider").parentElement;
    ...
    const pagination = parentSliders.querySelector(".swiper-pagination");
    const pageProductThumbs = new Swiper(".product-block__thumbs", {
    ...
    new Swiper(".product-block__slider", {
      // Вказуємо склас потрібного слайдера
      // Підключаємо модулі слайдера
      // для конкретного випадку
      modules: [Thumb, Mousewheel, Pagination],
      observer: true,
      observeParents: true,
      slidesPerView: 1,
      spaceBetween: 16,
  ...
  if (document.querySelector(".product-detail__slider")) {
    const parentSliders = document.querySelector(".product-detail__slider").parentElement.parentElement;
    const arrowPrev = parentSliders.querySelector(".swiper-button-prev");
    const arrowNext = parentSliders.querySelector(".swiper-button-next");
    const pagination = parentSliders.querySelector(".swiper-pagination");
    new Swiper(".product-detail__slider", {
      ...
      on: {
        slideChange: function() {
          const fractionEl = parentSliders.querySelector(".swiper-fraction");
          const currentSlide = this.realIndex + 1;
          const totalSlides = this.slides.length - (this.loop ? 2 : 0);
          fractionEl.textContent = `${currentSlide} / ${totalSlides}`;
        },
        init: function() {
          const fractionEl = parentSliders.querySelector(".swiper-fraction");
          const currentSlide = this.realIndex + 1;
  ...
  if (document.querySelector(".reviews-block__slider")) {
    let toggleLockSliderClass2 = function(sliderEl) {
    ...
    var toggleLockSliderClass = toggleLockSliderClass2;
    const sliders = document.querySelectorAll(".reviews-block__slider");
    sliders.forEach((slider, index) => {
      const parentSliders = slider.parentElement;
      const arrowPrev = parentSliders.querySelector(".swiper-button-prev");
      const arrowNext = parentSliders.querySelector(".swiper-button-next");
      parentSliders.querySelector(".swiper-pagination");
      new Swiper(slider, {
  ...
  if (document.querySelector(".proposals-block__slider")) {
    const sliders = document.querySelectorAll(".proposals-block__slider");
    sliders.forEach((slider, index) => {
      const parentSliders = slider.parentElement;
      const arrowPrev = parentSliders.querySelector(".swiper-button-prev");
      const arrowNext = parentSliders.querySelector(".swiper-button-next");
      const scrollbar = parentSliders.querySelector(".swiper-scrollbar");
      const isInProductBlock = slider.closest(".product-block__inner");
      new Swiper(slider, {
  ...
  if (document.querySelector(".to-block__slider")) {
    const sliders = document.querySelectorAll(".to-block__slider");
    sliders.forEach((slider, index) => {
      const parentSliders = slider.parentElement;
      const arrowPrev = parentSliders.querySelector(".swiper-button-prev");
      const arrowNext = parentSliders.querySelector(".swiper-button-next");
  ...
  if (document.querySelector(".hero-block__slider")) {
    const sliders = document.querySelectorAll(".hero-block__slider");
    sliders.forEach((slider, index) => {
      const parentSliders = slider.parentElement;
      const arrowPrev = parentSliders.querySelector(".swiper-button-prev");
      const arrowNext = parentSliders.querySelector(".swiper-button-next");
  ...
  if (document.querySelector(".categories-block__slider")) {
    const sliders = document.querySelectorAll(".categories-block__slider");
    sliders.forEach((slider, index) => {
      const parentSliders = slider.parentElement;
      parentSliders.querySelector(".swiper-button-prev");
      parentSliders.querySelector(".swiper-button-next");
      const scrollbar = parentSliders.querySelector(".swiper-scrollbar");
      const isInBlock = slider.closest(".categories-block__inner");
      const isInCatalog = slider.closest(".catalog--categories");
      const swiperSettings = {
        modules: [Mousewheel, Scrollbar, Grid],
        observer: true,
        observeParents: true,
        slidesPerView: 3,
        spaceBetween: 1,
      ...
      if (isInCatalog) {
        resizableSwiper("(max-width: 1199.98px)", slider, swiperSettings);
      } else {
        new Swiper(slider, swiperSettings);
      }
    });
  }
  if (document.querySelector(".blog-articles__slider")) {
    const sliders = document.querySelectorAll(".blog-articles__slider");
    sliders.forEach((slider, index) => {
      const parentSliders = slider.parentElement;
      const scrollbar = parentSliders.querySelector(".swiper-scrollbar");
      new Swiper(slider, {
  ...
  if (document.querySelector(".reviews-google__slider")) {
    const sliders = document.querySelectorAll(".reviews-google__slider");
    sliders.forEach((slider, index) => {
      const parentSliders = slider.parentElement;
      const scrollbar = parentSliders.querySelector(".swiper-scrollbar");
      const arrowPrev = parentSliders.querySelector(".swiper-button-prev");
  ...
  if (document.querySelector(".promotions-block__slider")) {
    const sliders = document.querySelectorAll(".promotions-block__slider");
    sliders.forEach((slider, index) => {
      const parentSliders = slider.parentElement;
      const arrowPrev = parentSliders.querySelector(".swiper-button-prev");
      const arrowNext = parentSliders.querySelector(".swiper-button-next");
  ...
  if (document.querySelector(".choice-motozilla")) {
    const sliders = document.querySelectorAll(".choice-motozilla");
    sliders.forEach((slider, index) => {
      const choiseSlider = slider.querySelector(".choice-motozilla__slider");
      const choiseDescr = slider.querySelector(".choice-motozilla__descr");
      const arrowPrev = slider.querySelector(".swiper-button-prev");
      const arrowNext = slider.querySelector(".swiper-button-next");
      const pagination = slider.querySelector(".swiper-pagination");
      const choiseDescrSlider = new Swiper(choiseDescr, {
      ...
      const choiseCardSlider = new Swiper(choiseSlider, {
        modules: [Pagination, Navigation, Mousewheel, Controller],
        observer: true,
        observeParents: true,
        slidesPerView: 1,
      ...
      choiseDescrSlider.controller.control = choiseCardSlider;
      choiseCardSlider.controller.control = choiseDescrSlider;
    });
  }
}
...
class Popup {
  ...
  updateOpenButtons(isActive, selector) {
    const targetSelector = selector || this.targetOpen.selector;
    if (!targetSelector) return;
    const attr = this.options.attributeOpenButton;
    const selectorAttr = `[${attr}="${targetSelector}"]`;
    const buttons = document.querySelectorAll(selectorAttr);
    buttons.forEach((btn) => {
      if (isActive) {
  ...
  // Новий метод для очищення всіх активних кнопок
      ...
      (function(e) {
        ...
        if (buttonOpen) {
          ...
          if (this._dataValue !== "error") {
            if (this.isOpen && this.targetOpen.selector === this._dataValue) {
              this.close();
              return;
            }
  ...
  open(selectorValue) {
    if (bodyLockStatus) {
      ...
      if (this.isOpen) {
        this._reopen = true;
        const previousSelector = this.targetOpen.selector;
        this.close();
        if (previousSelector) {
          this.updateOpenButtons(false, previousSelector);
        }
      }
      ...
      if (this.targetOpen.element) {
        ...
        document.documentElement.setAttribute("data-popup", this.targetOpen.selector);
        if (!this._reopen) {
  ...
  close(selectorValue) {
    ...
    const closingSelector = this.previousOpen.selector;
    ...
    if (!this._reopen) {
      ...
      this.isOpen = false;
      this.updateOpenButtons(false, closingSelector);
    }
    this._removeHash();
...
function formQuantity() {
  document.addEventListener("DOMContentLoaded", () => {
    const containers = document.querySelectorAll("[data-fls-quantity]");
  ...
  document.addEventListener("blur", quantityActions);
  ...
  function quantityActions(e) {
    ...
    if (type === "click") {
      ...
      let newValue = valueElement.value.replace(/\D/g, "");
...
window.initMenu = function() {
  ...
  if (!isTouch && !isMobile.any()) {
    let getSlope2 = function(a, b) {
      return (b.y - a.y) / (b.x - a.x);
    }, isMovingToMenu2 = function(menu) {
      ...
      const decreasingSlope = getSlope2(loc, upperLeft);
      const increasingSlope = getSlope2(loc, lowerLeft);
      const prevDecreasingSlope = getSlope2(prevLoc, upperLeft);
      const prevIncreasingSlope = getSlope2(prevLoc, lowerLeft);
      return decreasingSlope < prevDecreasingSlope && increasingSlope > prevIncreasingSlope;
    };
    var getSlope = getSlope2, isMovingToMenu = isMovingToMenu2;
    ...
    document.querySelectorAll("[data-menu]").forEach((button) => {
      ...
      const possiblyActivate = () => {
        ...
        if (isMovingToMenu2(menu)) {
          timeoutId = setTimeout(possiblyActivate, DELAY);
        } else {
...
window.initSubmenu = function() {
  ...
  const ACTIVE_LEVEL_CLASS = "is-active";
  const html = document.documentElement;
  const isTouch = "ontouchstart" in window || navigator.maxTouchPoints > 0;
  const isMobile2 = ((_b = (_a = window.isMobile) == null ? void 0 : _a.any) == null ? void 0 : _b.call(_a)) || false;
  const submenuInstances = /* @__PURE__ */ new Set();
  if (!window.__submenuGlobalInit) {
    window.__submenuGlobalInit = true;
    document.addEventListener("click", (e) => {
      submenuInstances.forEach((instance) => {
    ...
    document.addEventListener("keydown", (e) => {
      ...
      submenuInstances.forEach((instance) => instance.closeAll());
    });
  }
  class Submenu {
    constructor(root) {
      this.root = root;
      this.openedLevels = /* @__PURE__ */ new Map();
      this.listeners = [];
      this.hoverTimer = null;
      this.closeTimer = null;
      this._moveTimer = null;
      this._pointerLeaveTimer = null;
      ...
      this.currentPointerLevel = 1;
      this.isHovering = false;
      this.pendingOpenId = null;
      this.init();
      submenuInstances.add(this);
    }
    init() {
      this.parseLevels();
      this.parsePanels();
    ...
    getCurrentLevelByPanel(panel) {
      const levelWrap = panel.closest("[data-submenu-level]");
      if (!levelWrap) return 1;
      return Number(levelWrap.dataset.submenuLevelIndex || 1);
    }
    parseLevels() {
      this.levels = [...this.root.querySelectorAll("[data-submenu-level]")];
      this.levels.forEach((level, index) => {
        level.dataset.submenuLevelIndex = index + 1;
      });
    }
    parsePanels() {
      const panels = [...this.root.querySelectorAll("[data-submenu-panel]")];
      panels.forEach((panel) => {
        const id = panel.dataset.submenuPanel;
        if (!id) return;
        this.panels.set(id, panel);
      });
    }
    buildStructure() {
      const rootButtons = [...this.root.children[0].querySelectorAll("[data-submenu-id]")];
      rootButtons.forEach((btn) => {
        const id = btn.dataset.submenuId;
        const panel = this.getPanel(id);
        if (!panel) return;
        btn.dataset.submenuLevel = 1;
        this.structure.set(id, {
          ...
          clickOnly: btn.hasAttribute("data-submenu-click")
        });
      });
      this.panels.forEach((panel, parentId) => {
        const level = this.getCurrentLevelByPanel(panel);
        const nestedButtons = [...panel.querySelectorAll("[data-submenu-id]")].filter(
          (btn) => btn.closest("[data-submenu-panel]") === panel
        );
        nestedButtons.forEach((btn) => {
          const id = btn.dataset.submenuId;
          const childPanel = this.getPanel(id);
          if (!childPanel) return;
          const nextLevel = level + 1;
          btn.dataset.submenuParent = parentId;
          btn.dataset.submenuLevel = nextLevel;
          childPanel.dataset.submenuParent = parentId;
          this.structure.set(id, {
            id,
            level: nextLevel,
            parent: parentId,
    ...
    getLevelOfElement(el) {
      if (!el) return null;
      const button = el.closest("[data-submenu-id]");
      if (button) {
        const item = this.structure.get(button.dataset.submenuId);
        if (item) return item.level;
      }
      const panel = el.closest("[data-submenu-panel]");
      if (panel) {
        return this.getCurrentLevelByPanel(panel);
      }
      return null;
    }
    bindEvents() {
      this.addListener(this.root, "click", (e) => {
        const btn = e.target.closest("[data-submenu-id]");
        const closeBtn = e.target.closest("[data-submenu-back]");
        const closeAllBtn = e.target.closest("[data-submenu-close]");
        if (btn && this.root.contains(btn)) {
          const id = btn.dataset.submenuId;
          const item = this.structure.get(id);
          if (!item) return;
          e.preventDefault();
          const isOpened = this.openedLevels.get(item.level) === id;
          if (isOpened) {
        ...
        if (closeBtn) {
          e.preventDefault();
          const levelWrap = closeBtn.closest("[data-submenu-level]");
          if (!levelWrap) return;
          const level = Number(levelWrap.dataset.submenuLevelIndex);
      ...
      if (!isTouch && !isMobile2) {
        this.structure.forEach((item) => {
          const { button, panel, id, level, clickOnly } = item;
          if (clickOnly) return;
          const onEnter = () => {
            clearTimeout(this.closeTimer);
            clearTimeout(this._pointerLeaveTimer);
            if (this.pendingOpenId && this.pendingOpenId !== id) {
              clearTimeout(this.hoverTimer);
              this.pendingOpenId = null;
            }
            const currentId = this.openedLevels.get(level);
            if (currentId !== id) {
          ...
          const onLeave = (e) => {
            ...
            this.handlePointerLeave(level, e);
          };
          this.addListener(button, "mouseenter", onEnter);
          this.addListener(button, "mouseleave", onLeave);
          this.addListener(panel, "mouseenter", () => {
            clearTimeout(this.closeTimer);
            clearTimeout(this._pointerLeaveTimer);
            if (this.pendingOpenId === id) {
              clearTimeout(this.hoverTimer);
          ...
          this.addListener(panel, "mouseleave", (e) => {
            this.handlePointerLeave(level, e);
          });
        });
        this.addListener(this.root, "mousemove", (e) => {
          this._lastX = e.clientX;
          this._lastY = e.clientY;
          const target = e.target;
          const targetLevel = this.getLevelOfElement(target);
          if (targetLevel !== null && this.openedLevels.size > 0) {
            const maxOpenedLevel = Math.max(...this.openedLevels.keys());
            if (targetLevel < maxOpenedLevel) {
              clearTimeout(this._moveTimer);
              this._moveTimer = setTimeout(() => {
                const maxNow = this.openedLevels.size ? Math.max(...this.openedLevels.keys()) : 0;
                if (targetLevel < maxNow) {
                  this.closeLevelsAfter(targetLevel);
                }
              }, 80);
            } else {
              clearTimeout(this._moveTimer);
        ...
        this.addListener(this.root, "mouseleave", (e) => {
    ...
    _startPointerTracking() {
      ...
      this._pointerHandler = (e) => {
        ...
        if (!el || !this.root.contains(el)) {
          clearTimeout(this._pointerLeaveTimer);
          this._pointerLeaveTimer = setTimeout(() => {
            this.closeAll();
          }, this.CLOSE_DELAY);
        } else {
          clearTimeout(this._pointerLeaveTimer);
    ...
    updateLevelTitle(level, title) {
      const levelWrap = this.levels[level - 1];
      if (!levelWrap) return;
      const titleEl = levelWrap.querySelector("[data-submenu-title]");
      if (titleEl) titleEl.textContent = title;
    }
    updateLevelStates() {
      this.levels.forEach((level) => {
        const hasActive = level.querySelector(`.${ACTIVE_CLASS}`);
        level.classList.toggle(ACTIVE_LEVEL_CLASS, !!hasActive);
      });
    }
    handlePointerLeave(level, e) {
      clearTimeout(this.closeTimer);
      const related = e.relatedTarget;
      if (!related) {
        this._startPointerTracking();
      ...
      this.closeTimer = setTimeout(() => {
        const currentId = this.openedLevels.get(level);
        if (!currentId) return;
        const item = this.structure.get(currentId);
        if (!item) return;
        let isInside = false;
        let checkElement = related;
        while (checkElement && checkElement !== this.root) {
          if (checkElement === item.button || checkElement === item.panel) {
            isInside = true;
            break;
          }
          if (checkElement.closest && checkElement.closest("[data-submenu-panel]") === item.panel) {
            isInside = true;
            break;
          }
        ...
        if (isInside) return;
        const targetLevel = this.getLevelOfElement(related);
        if (targetLevel !== null && targetLevel < level) {
          this.closeLevelsAfter(targetLevel);
        } else if (targetLevel === null || targetLevel < level) {
          this.closeLevelsAfter(level - 1);
        }
      }, this.CLOSE_DELAY);
    }
    open(id) {
      ...
      if (currentId && currentId !== id) {
        this.deactivate(currentId);
        this.openedLevels.delete(level);
      }
      this.activate(id);
      this.openedLevels.set(level, id);
      this.positionPanel(item.panel, item.button);
      html.classList.add("submenu-open");
    }
    activate(id) {
      const item = this.structure.get(id);
      if (!item) return;
      item.panel.classList.add(ACTIVE_CLASS);
      item.button.classList.add(ACTIVE_BUTTON_CLASS);
      item.panel.setAttribute("aria-hidden", "false");
      item.button.setAttribute("aria-expanded", "true");
      item.panel.inert = false;
      this.updateLevelTitle(item.level, item.title);
      this.updateLevelStates();
    }
    deactivate(id) {
      const item = this.structure.get(id);
      if (!item) return;
      item.panel.classList.remove(ACTIVE_CLASS);
      item.button.classList.remove(ACTIVE_BUTTON_CLASS);
      item.panel.setAttribute("aria-hidden", "true");
      item.button.setAttribute("aria-expanded", "false");
      item.panel.inert = true;
      this.updateLevelStates();
    ...
    closeLevel(level) {
      this.closeLevelsAfter(level - 1);
      const id = this.openedLevels.get(level);
      if (!id) return;
      this.deactivate(id);
      this.openedLevels.delete(level);
      if (!this.openedLevels.size) {
        html.classList.remove("submenu-open");
      }
    }
    closeLevelsAfter(level) {
      [...this.openedLevels.entries()].forEach(([lvl, id]) => {
        if (lvl > level) {
          this.deactivate(id);
          this.openedLevels.delete(lvl);
        }
      });
    }
    closeAll() {
      this.openedLevels.forEach((id) => this.deactivate(id));
      this.openedLevels.clear();
      clearTimeout(this.hoverTimer);
      clearTimeout(this.closeTimer);
      clearTimeout(this._moveTimer);
      clearTimeout(this._pointerLeaveTimer);
    ...
    positionPanel(panel, button) {
      if (!panel || !button || isMobile2) return;
      ...
      panel.style.setProperty("--submenu-top", `${rect.top}px`);
      panel.style.setProperty("--submenu-btn-bottom", `${rect.bottom}px`);
    }
    destroy() {
      this.closeAll();
      ...
      this.listeners = [];
      submenuInstances.delete(this);
    }
  }
  const instances = [];
  document.querySelectorAll("[data-submenu-root]").forEach((root) => {
    instances.push(new Submenu(root));
  });
  window.submenuAPI = {
    instances,
    closeAll() {
      instances.forEach((i) => i.closeAll());
    },
    destroyAll() {
...
document.querySelector("[data-tippy-content]") ? tippy("[data-tippy-content]", {
...
if (topPositionBlocks.length) {
  let setVar = function(el, name, value) {
    ...
    measurements.forEach(({ block, topPosition, left, width, nav }) => {
      ...
      setVar(block, "--header-offset-height", `${headerOffsetHeight}px`);
      setVar(block, "--top-info-height", `${topInfoHeight}px`);
      if (nav) {
  ...
  var setVar2 = setVar, updateTopPositions2 = updateTopPositions, onScroll = onScroll2, runAfterLayout2 = runAfterLayout;
  const header = document.querySelector("header");
  const headerOffsetEl = header == null ? void 0 : header.querySelector("[data-header-offset]");
...
function initStickyBlocks() {
  const stickyParents = document.querySelectorAll("[data-sticky-parent]");
  if (!stickyParents.length) return;
  const instances = [];
  stickyParents.forEach((parent, index) => {
    const stickyBlock = parent.querySelector("[data-sticky-block]");
    if (!stickyBlock) return;
    const stickyClass = stickyBlock.getAttribute("data-sticky-class") || "block-fixed";
    const instance = {
      offset: 0,
      isFixed: false,
      stickyClass
    ...
    instance.offset = getStickyOffset();
    function setHeaderOffset() {
      const height = stickyBlock.offsetHeight;
      parent.style.setProperty("--sticky-offset", `${height}px`);
    }
    function clearHeaderOffset() {
      parent.style.removeProperty("--sticky-offset");
    }
    function handleScroll() {
      const shouldBeFixed = window.scrollY >= instance.offset;
      if (shouldBeFixed === instance.isFixed) return;
      instance.isFixed = shouldBeFixed;
      if (shouldBeFixed) {
        stickyBlock.classList.add("--fixed");
        stickyBlock.setAttribute("data-fls-lp", "");
        document.documentElement.classList.add(instance.stickyClass);
        setHeaderOffset();
      } else {
        stickyBlock.classList.remove("--fixed");
        stickyBlock.removeAttribute("data-fls-lp");
        document.documentElement.classList.remove(instance.stickyClass);
        clearHeaderOffset();
      }
    }
    function updateOffset() {
      const wasFixed = instance.isFixed;
      if (wasFixed) {
        stickyBlock.classList.remove("--fixed");
        document.documentElement.classList.remove(instance.stickyClass);
      }
    ...
    resizeObserver.observe(stickyBlock);
    handleScroll();
  });
  window.stickyBlocksInstances = instances;
}
if (document.readyState === "loading") {
  document.addEventListener("DOMContentLoaded", initStickyBlocks);
} else {
  initStickyBlocks();
}
  ...
  btn.addEventListener("click", (e) => {
    ...
    if (parent) {
      if (isActive) {
        ...
        closeAllDropdowns(parent, block);
        setTimeout(() => {
...
window.customMiniSelect = function() {
  ...
  selParents.forEach((selBlock) => {
    ...
    function checkAndSetPlaceholder() {
      ...
      const hasActiveOption = Array.from(selOptions).some((o) => o.classList.contains("is-active"));
      if (!hasActiveOption) {
    ...
    function closeDropdown() {
      ...
      setTimeout(() => {
        selBlock.classList.remove("is-out-left", "is-out-right");
        document.documentElement.classList.remove("sel-open");
      }, 300);
      isOpen = false;
    ...
    selDropdownButton.addEventListener("click", (e) => {
      const isClickOnInput = isSearch && e.target === selDropdownInput;
      if (isClickOnInput && isOpen) return;
      if (!isOpen) {
        isOpen = true;
      } else {
        isOpen = false;
      ...
      document.documentElement.classList.toggle("sel-open", isOpen);
      if (isOpen) {
    ...
    selOptions.forEach((item) => {
      item.addEventListener("click", () => {
        ...
        if (selDropdownInput) {
          ...
          if (typeof initInputEffects === "function") {
            initInputEffects();
          }
...
function initTimers() {
  const timers = document.querySelectorAll(".promotions-block__timer");
  timers.forEach((timerEl) => {
    const timeStr = timerEl.dataset.time;
    if (!timeStr) return;
...
function rangeInit() {
  const rangePriceSlider = document.querySelectorAll("[data-fls-range]");
...
if (filtersBlock.length) {
  filtersBlock.forEach((block) => {
    const filterItems = block.querySelectorAll(".filters-aside__item");
    filterItems.forEach((item) => {
      const itemToggle = item.querySelector(".filters-aside__toggle");
